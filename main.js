...
`, "",{"version":3,"sources":["webpack://./src/components/upcoming-forecast/threeDayForecast.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,+CAA+C;EAC/C;;;WAGS;EACT,oBAAoB;EACpB,qBAAqB;AACvB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,eAAe;EACf,WAAW;EACX,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,SAAS;EACT,iBAAiB;AACnB","sourcesContent":[".upcoming-day-forecast {\n  display: grid;\n  grid-template: auto 64px auto / repeat(2, auto);\n  grid-template-areas:\n    'day day'\n    'icon icon'\n    'hi lo';\n  align-content: start;\n  justify-items: center;\n}\n\n.upcoming-day-forecast h3 {\n  grid-area: day;\n}\n\n.upcoming-day-forecast img {\n  grid-area: icon;\n  width: 64px;\n  height: auto;\n}\n\n.day-forecast-hitemp {\n  grid-area: hi;\n}\n\n.day-forecast-lotemp {\n  grid-area: lo;\n}\n\n#threeDay-forecast-container {\n  display: flex;\n  gap: 48px;\n  padding-top: 48px;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const forecastDay = (forecastData) => {
  ...
  hiTemp.textContent = Math.round(forecastData.maxTemperatureFarenheit);
  loTemp.classList.add('day-forecast-lotemp');
  loTemp.textContent = Math.round(forecastData.minTemperatureFarenheit);
