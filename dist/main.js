...
`, "",{"version":3,"sources":["webpack://./src/assets/css/styles.css"],"names":[],"mappings":"AAEA;EACE,sBAAsB;EACtB,qCAAqC;EACrC,iBAAiB;EACjB,gBAAgB;EAChB,YAAY;EACZ,cAAc;EACd,8CAA8C;EAC9C,6DAAqE;EACrE,4BAA4B;EAC5B,sBAAsB;AACxB;;AAEA;;;EAGE,mBAAmB;EACnB,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,aAAa;EACb,2CAA2C;EAC3C,qBAAqB;EACrB,SAAS;AACX","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap');\n\nhtml {\n  box-sizing: border-box;\n  font-family: 'Montserrat', sans-serif;\n  font-size: 1.2rem;\n  font-weight: 700;\n  height: 100%;\n  color: #f5f5f5;\n  text-shadow: 1px 2px 3px rgba(62, 60, 55, 0.8);\n  background: url(../images/background-scenery-landscape.jpg) no-repeat;\n  background-attachment: fixed;\n  background-size: cover;\n}\n\n*,\n*::before,\n*::after {\n  box-sizing: inherit;\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  min-height: 100%;\n}\n\n#page-container {\n  min-height: 100vh;\n  padding: 16px 0px;\n  display: grid;\n  grid-template-rows: auto auto auto 1fr auto;\n  justify-items: center;\n  gap: 48px;\n}\n"],"sourceRoot":""}]);
// Exports
