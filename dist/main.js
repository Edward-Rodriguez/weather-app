...
function temperatureHeader(weatherData, forecastData) {
  ...
  time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(weatherInfo.localtime), 'EEEE, MMM do p');
...
const forecastDay = (forecastData) => {
  ...
  const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(forecastData.date, 'yyyy-MM-dd', new Date());
  day.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(date, 'EEE');
